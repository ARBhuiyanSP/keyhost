-- Rewards Points System Tables - FIXED VERSION
...
-- Step 2: Create member_status_tiers FIRST (before user_rewards_points)
...
-- Step 3: Create user_rewards_points WITHOUT foreign keys first
...
-- Step 3a: Add foreign keys separately (this way errors are clearer)
...
-- Step 4: Create rewards_point_transactions WITHOUT foreign keys first
...
-- Step 4a: Add foreign keys separately
