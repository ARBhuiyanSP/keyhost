-- Rewards Points System - FINAL VERSION for phpMyAdmin
-- This version handles INT vs INT UNSIGNED compatibility

-- ============================================
-- STEP 1: Check users table structure first
-- Run this query first to check data types:
...
-- ============================================
-- STEP 3: Create user_rewards_points (NO FOREIGN KEYS)
-- ============================================
...
-- ============================================
-- STEP 4: Create rewards_point_transactions (NO FOREIGN KEYS)
-- ============================================
...
-- ============================================
-- STEP 5: Insert default data (run before adding foreign keys)
-- ============================================
...
-- ============================================
-- STEP 6: Add foreign keys (run these ONE BY ONE)
-- If any fails, check the data type mismatch
-- ============================================

-- Foreign key 1: user_rewards_points -> users
...
-- Foreign key 2: user_rewards_points -> member_status_tiers
ALTER TABLE user_rewards_points
...
-- Foreign key 3: rewards_point_transactions -> users
...
-- Foreign key 4: rewards_point_transactions -> bookings
ALTER TABLE rewards_point_transactions
