-- Rewards Points System - Version with INT UNSIGNED support
-- Use this if users.id is INT UNSIGNED
...
-- ============================================
-- STEP 3: Create user_rewards_points with INT UNSIGNED
-- Change INT to INT UNSIGNED if users.id is UNSIGNED
-- ============================================
...
-- ============================================
-- STEP 4: Create rewards_point_transactions with INT UNSIGNED
-- ============================================
...
-- ============================================
-- STEP 6: Add foreign keys (NOW they should work)
-- ============================================
