-- Rewards Points System - Step by Step (Run each section separately)

-- ============================================
-- STEP 1: Check users table structure first
-- ============================================
-- Run this first to see what data type users.id is:
-- SHOW COLUMNS FROM users WHERE Field = 'id';
-- SHOW COLUMNS FROM bookings WHERE Field = 'id';

-- ============================================
-- STEP 2: Create basic tables (no foreign keys)
-- ============================================
...
-- ============================================
-- STEP 3: Create user_rewards_points WITHOUT foreign keys
-- ============================================
...
-- ============================================
-- STEP 4: Create rewards_point_transactions WITHOUT foreign keys
-- ============================================
...
-- ============================================
-- STEP 5: Add foreign keys (run these one by one)
-- ============================================

-- Add foreign key to users table
-- If this fails, check: SHOW COLUMNS FROM users WHERE Field = 'id';
...
-- Add foreign key to member_status_tiers
ALTER TABLE user_rewards_points
...
-- Add foreign key to users table for transactions
...
-- If this fails, check: SHOW COLUMNS FROM bookings WHERE Field = 'id';
ALTER TABLE rewards_point_transactions
...
-- SHOW COLUMNS FROM bookings LIKE 'points_%';
