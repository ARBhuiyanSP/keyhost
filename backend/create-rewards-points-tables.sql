...
-- Insert default rewards point slots (example: 1000-5000 taka = 10 points per 1000 taka)
...
-- Add points columns to bookings table (run separately if columns already exist)
