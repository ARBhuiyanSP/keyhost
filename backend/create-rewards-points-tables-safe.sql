-- Rewards Points System Tables
-- Run this file after users and bookings tables exist

-- Rewards Point Slots (spending ranges for earning points)
...
-- Rewards Point Settings (conversion rates, etc.)
...
-- Member Status Tiers (Silver, Gold, Platinum, etc.)
-- Must be created BEFORE user_rewards_points
...
-- User Rewards Points (current balance and total earned)
-- Requires: users table and member_status_tiers table
...
-- Rewards Point Transactions (history of all point transactions)
-- Requires: users table and bookings table
...
-- Insert default rewards point settings
...
-- Insert default member status tiers
...
-- Insert default rewards point slots
