...
async function testPayoutCalculation29() {
    try {
        ...
        const [rows] = await pool.query(`
            SELECT
                b.id AS booking_id,
                b.booking_reference,
                b.total_amount as base_room_amount,
        ...
        console.log('Property Owner 29 (Hotel Jannat) Payout Calculation Verification:');
        console.log(rows);
        process.exit(0);
    } catch (err) {
        console.error(err);
