    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Properties you've saved for later</p>
        </div>
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center">
            ...
            <button
              ...
              className="bg-rose-600 hover:bg-rose-700 text-white font-semibold py-3 px-8 rounded-xl shadow-md transition-all duration-200 transform hover:-translate-y-1"
            >
              Start Exploring
            </button>
          </div>
              ...
              <div key={favorite.id} className="bg-white rounded-lg shadow overflow-hidden">
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right ml-2">
                      <p className="text-lg font-semibold text-gray-900">
                        {formatPrice(favorite.base_price)}
                      </p>
                  ...
                  <div className="mt-4 flex space-x-2">
                    ...
                    <button
                      onClick={() => navigate(`/booking/${favorite.property_id}`)}
