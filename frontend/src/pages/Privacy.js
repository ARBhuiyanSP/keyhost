        ...
        <div className="bg-gray-50 min-h-screen font-sans selection:bg-indigo-200 pb-20">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-navy-900 relative py-8 overflow-hidden rounded-b-[3rem] shadow-2xl mb-6">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-[fadeInUp_1s_ease-out_forwards]">
                    <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-2 text-white">Privacy Policy</h1>
                    ...
                    <div className="mt-3 inline-flex items-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 shadow-sm text-xs font-medium text-white">
                        ...
                        <span className="text-white">Effective Date: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className={settings.privacy_policy ? "w-full" : "lg:w-3/4"}>
                        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8 md:p-14 mb-10 animate-[fadeInUp_1s_ease-out_0.4s_forwards] opacity-0">
                            ...
                            <div className="prose prose-indigo max-w-none text-gray-900 leading-loose prose-headings:text-navy-900 prose-headings:font-bold prose-p:font-normal prose-p:text-lg">

                                {settings.privacy_policy ? (
                                    <div className="whitespace-pre-wrap font-normal text-lg text-gray-900 tracking-wide">
                                        {settings.privacy_policy}
                                    </div>
                                ) : (
                                    <>
